...
正如前文所叙述的，Zoho Projects和CORNERSTONE都是全方位的项目管理协作平台，而TAPD是一款专门针对敏捷开发的项目管理软件，所以前两者在可支持的工具和业务上都要更加细节和丰富，比如用于可视化协作管理的多元化看板、文档共享，或者在项目进程管理中的工具如甘特图、蓝图，亦或者用于测试管理的bug追踪等功能，在这些方面，Zoho Projects 和CORNERSTONE都做的很完善，他们的主要区别可能在于一些其他辅助的地方，比如前者支持内网知识库以及论坛交流，后者则支持思维导图以及代码助手等，所以这两个之间的选择就更倾向于用户的习惯。

当然，Zoho Projects 和CORNERSTONE也同样支持敏捷开发的管理，但是TAPD作为专用于这一特定开发手段的工具，对其的支持也就更加细致和完善。在提供敏捷开发所必要的几个管理工具如敏捷需求规划、任务工时管理等基本功能外，TAPD还提供了三种敏捷协作解决方案，即轻量协作解决方案、敏捷研发解决方案以及Devops解决方案；当然，使用得当前两个一样可以实现类似的效果，但是相比于TAPD就会显得笨重和复杂了。



## 二、产品使用设想

> 从上述软件产品中，我们选择TAPD产品界面表达假想项目产品的使用，并给出简单的未来产品使用描述。
...
### 1. Zoho Projects
Zoho Projects对不同的服务有五种套餐：免费版、标准版、精简版、高级版、企业版
下面从各个角度分析一下每个版本的政策：
* 价格

![ZOHO服务定价](./Images/ZOHO-服务定价.png)


* 基础功能

![ZOHO基础功能分析](./Images/ZOHO-基础功能分析.png)

基本的项目数和用户数以及存储空间依次赠长，这是最基本的功能提升。

* 图表/报表

![ZOHO图表报表分析](./Images/ZOHO-图表报表分析.png)

图表报表的编辑权和编辑模式是付费后功能提升的主要点

* 核心功能

![ZOHO核心功能分析1](./Images/ZOHO-核心功能分析1.png)


![ZOHO核心功能分析2](./Images/ZOHO-核心功能分析2.png)

在交互方面：消息通知、文档共享、游戏化竞赛、提醒、事件跟踪这些方面都从有到无或从多到少
在任务的实施方面：任务管理、日历和论坛、任务持续时间、任务依赖关系、任务汇总等都有不同程度的提高
在任务的完成方面：MS项目导入、项目自定义状态、任务自定义状态、布局、项目预算之类的功能都是从有到无

* 其他还包含问题追踪器和集成方面
免费版和标准版都是具有问题导入和简单的zoho CRM功能，其他的功能随着版本的提升而增加。
...
TAPD的所有套餐在写下此文的当前时间都为免费全面开放 ，经查询过客服后，客服不排除未来有收费可能。并且在疫情期间免费开放企业版试用，为期6个月。
可以初步推断出现在TAPD是不盈利的，或许在用户群体上升到一定数量级别并参生依赖性后腾讯将会推出收费服务。
